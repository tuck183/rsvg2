...
function openModal(target, modalPath, clusterData, mapsFullScreen){
    ...
    if( mapsFullScreen === true ){
        $(".gm-style").append('<div class="modal modal-external fade show" id="'+ target +'" tabindex="-1" role="dialog" aria-labelledby="'+ target +'"><i class="loading-icon fa fa-circle-o-notch fa-spin"></i></div>');
    }
    else {
        $("body").append('<div class="modal modal-external fade show" id="'+ target +'" tabindex="-1" role="dialog" aria-labelledby="'+ target +'"><i class="loading-icon fa fa-circle-o-notch fa-spin"></i></div>');
    }
