        ...
        function placeMarkers(markers){
            ...
            for (i = 0; i < markers.length; i++) {
                ...
                if( markers[i]["featured"] == 1 ){
                    ...
                    '<div class="marker" data-id="'+ markers[i]["_id"] +'" data-url="'+ markers[i]["url"] +'" data-color="'+ color +'" data-i="'+ i +'">' +
                    ...
                    console.log('this is the project id ',markers[i]["_id"]);
                    markerContent.innerHTML =
                        '<div class="marker" data-id="'+ markers[i]["_id"] +'" data-url="'+ markers[i]["url"] +'"  data-color="'+ color +'" data-i="'+ i +'">' +
                            '<div class="title">'+ markers[i]["title"] +'</div>' +
                            '<div class="marker-wrapper">' +
                    ...
                    google.maps.event.addListener(marker, 'click', (function(marker, i) {
                        return function() {
                            if( markerTarget == "sidebar"){
                                ...
                                openModal($(this.content.firstChild).attr("data-id"), "/modal", false, isFullScreen);
                            }
                        }
                    })(marker, i));
                    ...
                    success: function(results){                     
                        ...
                        $(".result-item, .results-content .item").children("a").on("click", function(e){
                            if( sidebarResultTarget == "sidebar" ){
                                ...
                                e.preventDefault();
                                openModal( $(this).parent().attr("data-id"), "/modal",false, isFullScreen );
                            }
